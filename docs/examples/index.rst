...
2. `Updating your Delft-FIAT model with local data <../_examples/update_exposure_data.ipynb>`_
3. `Creating a Delft-FIAT model to assess road damage with OSM roads <../_examples/add_roadnetwork.ipynb>`_
