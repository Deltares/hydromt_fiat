...
3. `Updating your Delft-FIAT model with local data <../_examples/update_exposure_data.ipynb>`_
4. `Creating a Delft-FIAT model to assess road damage with OSM roads <../_examples/add_roadnetwork.ipynb>`_
