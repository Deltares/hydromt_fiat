...
_cases = {
    "setup_new_composite_area_datum": {
        ...
        "dir": "test_read",
        "new_root": P_DRIVE_TEST_DB / "test_setup_new_composite_area_datum",
        "composite_areas": P_DRIVE_TEST_DB / "test_read" / "new_development_area_test.gpkg",
        "type": "datum",
        "path_ref": None,
        "attr_ref": None,
    },
    "setup_new_composite_area_geom": {
        "data_catalogue": DATADIR / "hydromt_fiat_catalog_USA.yml",
        "dir": "test_read",
        "new_root": P_DRIVE_TEST_DB / "test_setup_new_composite_area_geom",
        "composite_areas": P_DRIVE_TEST_DB / "test_read" / "new_development_area_test.gpkg",
        "type": "geom",
        "path_ref": P_DRIVE_TEST_DB / "test_read" / "reference_groundHeight_test.shp",
        "attr_ref": "bfe",
    },
}
